...
Some questions struck us: what's the "shortest" half-inning that has never occurred in the major leagues?  If it has never occurred, how long can we expect to wait to see this half-inning in the future?  Of the half-innings that _have_ occurred which one has the lowest probability: _the most unlikely half-inning in Major League History_?  With a model, we can answer these questions---with substantial help from a computer and a powerful database.  We use a well-studied and often used model of baseball to get our answers.

So what's the shortest inning that has never been played?  We'll give this answer now, then review the rules of baseball, explain our notation, introduce our model, answer our questions, convey some fascinating statistics and reveal some compelling visualizations.

The shortest half-innings all have three plays---you need three 'at-bats' to get three outs. These and all other half-innings start with bases empty: **0**.  While the individual plays listed here have all occurred before, this exact sequence never has. Play 1: a triple: **0:3**.  Play 2: a double with the runner on third not advancing: **0:3:23**.  Play 3: a triple-play (three outs): **0:3:23:XXX**.
