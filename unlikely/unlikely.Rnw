...
With a model, we can compute probabilities of events occurring in the
future---events that may have already occurred in the past (be they
commonplace or rare), or even events that may have never occurred in
the past.
