...
sequences.
That said, an infinitude of remaining possibilities stand
unprecedented, and for as long the game of baseball persists, that
infinitude will continue to tantalize us.
